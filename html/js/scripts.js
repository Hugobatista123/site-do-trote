function calcular() {
    ...
    let soma = Number(acaoSocial) + Number(homenagem) + (2 * leite) + (pontosKit) + (15 * latadesup) + (5 * arroz) + Number(arroz1) + (2 * feijao) + Number(feijao1) + Number(0.5 * macarrao) + Number(oleo) + (pontosSangue)
